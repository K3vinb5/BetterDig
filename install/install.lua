...
shell.run("https://raw.githubusercontent.com/K3vinb5/BetterDig/main/lib/func.lua")
shell.run("cd ..")
--main
shell.run("mkdir main")
shell.run("cd main")
shell.run("https://raw.githubusercontent.com/K3vinb5/BetterDig/main/main/betterDig.lua")
shell.run("https://raw.githubusercontent.com/K3vinb5/BetterDig/main/main/setup.lua")
--shell.run("pastebin get uPSuc3vU connect_display.lua")
shell.run("cd ..")
--startup
shell.run("cd ..")
shell.run("https://raw.githubusercontent.com/K3vinb5/BetterDig/main/install/startup.lua")
shell.run("cd ..")
