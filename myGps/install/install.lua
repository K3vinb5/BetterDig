...
shell.run("cd main")
shell.run("wget https://raw.githubusercontent.com/K3vinb5/BetterDig/myGps/main/main/client.lua")
shell.run("wget https://raw.githubusercontent.com/K3vinb5/BetterDig/myGps/main/main/server.lua")
shell.run("wget https://raw.githubusercontent.com/K3vinb5/BetterDig/myGps/main/main/setup.lua")
shell.run("cd ..")
shell.run("cd ..")
if args[1] ~= nil then
    if args[1] == "0" then
